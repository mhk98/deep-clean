      ...
      <nav className="relative bg-white shadow-[0_6px_22px_rgba(9,29,58,.14)]">
        ...
        >
          ...
          <div className="hidden items-center gap-4 lg:flex">
            <a className="inline-flex h-11 min-w-32 items-center justify-center gap-3 bg-[#0d274d] px-6 text-sm font-black text-[#ffd366]" href="tel:+96599552956">
              Call now <span>→</span>
            </a>
      ...
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <div className="mt-8 inline-flex overflow-hidden rounded-br-[28px] rounded-tl-[28px] shadow-[0_0_18px_rgba(255,211,102,.5)]">
            <a className="inline-flex h-12 min-w-32 items-center justify-center gap-3 bg-white px-7 text-sm font-black text-[#0d274d]" href="tel:+96599552956">
              Call now <span>→</span>
            </a>
    ...
    <main className="min-h-screen overflow-hidden bg-white text-[#0d274d]" dir="ltr">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-16 md:grid-cols-[1.1fr_.9fr]">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-2xl font-black text-[#ffd366]">
              Golden Touch Company for General Building Cleaning
            </h2>
            <h3 className="mt-9 text-2xl font-black text-[#ffd366]">
              We give every space a golden touch
            </h3>
            <p className="mx-auto mt-8 max-w-2xl text-base leading-7 text-white">
              Golden Touch General Cleaning Company is committed to providing
            ...
            <div className="mt-10 inline-flex overflow-hidden rounded-br-[24px] rounded-tl-[24px]">
              <a className="inline-flex h-12 min-w-32 items-center justify-center gap-3 border border-[#ffd366] bg-[#0d274d] px-6 text-sm font-black text-[#ffd366]" href="tel:+96599552956">
                Call now <span>→</span>
              </a>
          ...
          <div className="space-y-10 text-center">
            <div>
              ...
              <p className="mx-auto mt-5 max-w-md text-base leading-7">
                Our mission is to provide the golden touch to every building by
            ...
            <div>
              ...
              <p className="mx-auto mt-5 max-w-md text-base leading-7">
                ...
                delivering the golden touch, ensuring every space we serve shines
      ...
      <section className="px-5 pb-24">
        <div className="mx-auto grid max-w-5xl items-center gap-14 md:grid-cols-2">
          ...
          <img
            alt="Golden Touch cleaning team"
